...
# Display header
echo -e "${CYAN}skip remove management By Riad (espaceriad.com)${NC}"
echo ""

# Prompt user for choice
PS3='Please enter your choice: '
options=("skip remove management" "Reboot & Exit")
select opt in "${options[@]}"; do
    case $opt in
        "Bypass MDM from Recovery")
            # skip remove management from Recovery
            echo -e "${YEL}skip remove management"
            ...
            echo -e "${GRN}Successfully blocked Management & Profile Domains"
            ...
            echo -e "${GRN} enrollment has been bypassed!${NC}"
