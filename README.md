# Skip remove management for MacOS 💻
...
#### Follow steps below to Skip remove management setup during a fresh installation of MacOS
...
5. Navigate to (https://github.com/riadahmedrabat/version.entreprise)
